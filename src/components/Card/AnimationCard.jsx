                ...
                <ul className='list-none z-40 text-sm flex flex-col relative font-["Inter"] gap-3 lg:w-[90%] font-medium px-12 xs:px-6 sm:px-6 md:px-0 md:mx-auto'>
                    ...
                    }
                    {
                        ...
                        <>
                            ...
                            <svg className={`w-[75rem] rotate-90 md:rotate-0 absolute -top-[47rem] md:top-[17.7rem] 3xl:top-[17.75rem] -left-[37.05rem] xs:-left-[39.15rem] md:-left-[75rem] z-10`} viewBox="0 0 1920 115" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg className={`block w-[395rem] rotate-90 absolute -top-[23rem] -left-[200.05rem] xs:-left-[202.125rem] md:rotate-0 md:top-[11.1rem] 3xl:top-[11.17rem]`} viewBox="0 0 1920 115" fill="none" xmlns="http://www.w3.org/2000/svg">
