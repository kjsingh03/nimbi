...
function Accordion({ques,ans,handleClick,id}) {
  return (
    <div className='accordion overflow-hidden transition-all duration-300 ease-in' id={id}>
      ...
      <p className='py-4 text-[0.8rem] xl:text-base'>{ans}</p>
    </div>
  )
}
...
//     }, {
//       width: to,
//       ease: width > 1720 ? "slow(0.2,0.7,true)" : "slow(0.9,0.7,false)",
//       scrollTrigger: {
//         trigger: ".roadmap-container",
//         start: width > 768 ? "top -1%" : "top 52%",
...
//         <div className="relative w-[90%] mx-auto h-[40vw] xl:h-[69vh] xl:w-[80%] 2xl:h-[76vh] 3xl:w-[1506px] 3xl:h-[694px] carousel">
...
//         <div className="roadmap-container  bg-[url(./assets/bigEllipse.png)] bg-[_33rem_33rem] bg-[152vw_6rem] xl:bg-[72vw_6rem] 3xl:bg-[77vw_6rem] bg-no-repeat flex flex-col sm:gap-0 overflow-x-hidden overflow-y-visible pt-[6.5rem] 3xl:pt-[9rem] ">
...
//               <img src={roadmap} className='roadmap absolute -top-[0rem] -right-[0] 3xl:right-14 5xl:right-48 -z-40' alt="" />
//             </div>
//           </div>
...
//                 </filter>
//               </svg>
//               {/* <svg className={`absolute -z-0 top-[6.9rem] xs:top-[4.9rem] xl:top-[16.5rem] left-[0rem] w-[202rem] md:w-[142rem] `} viewBox="0 0 1920 115" fill="none" xmlns="http://www.w3.org/2000/svg">
//                 <g filter='url(#filter1_d_1261_1133)'>
