            ...
            <div className="flex items-center justify-between sm:w-[90%] lg:w-[80%] mx-auto px-4">
                ...
                <div className="flex overflow-hidden">
                    <ul className="navbar flex flex-col gap-3 transition-all duration-200 ease-in px-8 py-16 lg:shadow-none shadow-xl z-[100] fixed left-0 top-0 bg-[#242d32] w-[16rem] h-screen" id="navbar">
                        <Link onClick={activeTab} to="/" className='py-5 px-4 cursor-pointer hover:text-[#54c7ee] active'>Home</Link>
                        <Link onClick={activeTab} to="/about" className='py-5 px-4 cursor-pointer hover:text-[#54c7ee] '>About</Link>
                        <Link onClick={activeTab} to="/team" className='py-5 px-4 cursor-pointer hover:text-[#54c7ee] '>Our Team</Link>
                        <Link onClick={activeTab} to="/documents" className='py-5 px-4 cursor-pointer hover:text-[#54c7ee] '>Documents</Link>
                        <Link onClick={activeTab} to="/faq" className='py-5 px-4 cursor-pointer hover:text-[#54c7ee] '>FAQ</Link>
                    </ul>
