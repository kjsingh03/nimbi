    ...
    return (
        <nav className='fixed w-full border-b border-b-[#c4c0c8] bg-[#242d32] z-50 '>
            ...
            <div className="flex overflow-hidden z-[100]">
                <ul className="bg-[url(./assets/mountain.png)] bg-no-repeat bg-[0rem_-2rem] bg-[_80rem_40rem] navbar z-[100] flex lg:hidden flex-col items-center gap-3 transition-all duration-200 ease-in px-8 py-10 lg:shadow-none shadow-xl fixed left-0 top-0 bg-[#242d32] text-center w-screen h-screen" id="navbar">
