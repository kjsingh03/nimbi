...
import { hero, svg1, svg2, svg3, author1, author2, author3, author4, author5, sec1, ellipse, goldWolf, bigEllipse, discord, icon, telegram, x, github, telegramIcon, discordIcon, twitterIcon, xIcon, vector, tick, mask, mountain, indicator } from './assets'
                  ...
                  <div className="phase">
                    <ul className='list-none z-40 text-xs flex flex-col relative gap-1 lg:w-[90%] xl:w-[70%] px-12 xs:px-6 sm:px-6 md:px-0 md:mx-auto'>
                      ...
                      <div className="w-[250rem] relative">
                        ...
                        <img src={mountain} className='absolute opacity-80 -top-[2rem] sm:-top-[31.5rem] w-full -left-[67rem] h-[20rem] sm:h-[34rem] z-[35]' alt="" />
                      </div>
                    </ul>
                ...
                <section>
                  <div className="phase ">
                    <ul className='list-none z-40  text-xs flex flex-col relative gap-1 lg:w-[90%] xl:w-[70%] px-12 xs:px-6 sm:px-6 md:px-0 md:mx-auto'>
                      ...
                      <img src={indicator} className="w-8 h-8 absolute left-[rem] top-[12.5rem]" />
                    </ul>
                    <div className="lg:w-[70%] px-12 xs:px-6 sm:px-16 md:px-0 md:mx-auto">
