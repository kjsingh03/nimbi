    ...
    <>
      <div className="flex flex-col gap-12 w-full xl:w-[80%] px-[2rem] md:px-[5rem] xl:px-[11rem] capitalize py-16 bg-[url('./assets/mountain.png')] bg-contain bg-left-bottom bg-no-repeat font-['Inter',sans-serif]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Accordion ques="What is the nimbi ecosystem?" ans="This is the wolfpack nimbi has built for us all to help support him and his mission to keep everything decentralized. join his wolfpack and support his mission." />
          <Accordion ques="How do I claim my tokens?" ans="Once the presale ends, connect your wallet and press the claim button." />
          <Accordion ques="Why is decentralization in cryptocurrency so important?" ans="Decentralization is important as it ensures the integrity and security of the blockchain network and aligns with the principles of transparency, trust, and peer-to-peer transactions that cryptocurrencies aim to achieve.2 Blockchain technology is used to increase security and anonymity, as transactions are protected by elaborate mathematical procedures, making them difficult to hack." />
          <Accordion ques="What is Crypto Dust Converter?" ans="With CDC, you can finally say goodbye to those pesky leftovers in your wallet. Convert your crypto dust into the Nimbi ecosystem and unleash a world of possibilities!" />
          <Accordion ques="What is the Crypto Lottery?" ans="Everything is open source and transparent with Crypto Lotto!" />
        </div>
